...
def check_login():
    ...
    if username == USERNAME and password == PASSWORD:
        ...
        x1.place(x=110, y=170, width=70, height=70)
        y1.place(x=180, y=170, width=90, height=70)
        z1.place(x=270, y=170, width=70, height=70)
        x2.place(x=110, y=255, width=70, height=80)
...
tk.Button(x1, text="数据", bg="skyblue", command=login, height=70, width=70, font=('Arial', 17)).pack()
tk.Button(x2, text="拍照", bg="skyblue", command=show, height=80, width=70, font=('Arial', 14)).pack()
tk.Button(y1, text="Y+", bg="skyblue", command=Y1, height=70, width=90, font=('Arial', 17)).pack()
tk.Button(y2, text="Y-", bg="skyblue", command=Y2, height=80, width=90, font=('Arial', 17)).pack()
tk.Button(z1, text="Z+", bg="skyblue", command=Z1, height=70, width=70, font=('Arial', 17)).pack()
tk.Button(z2, text="Z-", bg="skyblue", command=Z2, height=80, width=70, font=('Arial', 17)).pack()
tk.Button(start, text="开始", bg="skyblue", command=go, height=80, width=70, font=('Arial', 17)).pack()
